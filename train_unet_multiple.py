...
dir_checkpoint = Path('/mnt/data/bientd/segment_building/checkpoints_unet_mul/')
...
def train_model(
    ...
    train_set = BRTWDataset(root_folder = root_folder, img_size = img_size, is_training = True)
    val_set = BRTWDataset(root_folder = root_folder, img_size = img_size, is_training = False)
