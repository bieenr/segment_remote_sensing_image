...
segment_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(segment_path)
sys.path.append(segment_path + '/eval')
sys.path.append(segment_path + '/model')
...
def train_model(
    ...
    val_set = BuildingDataset(root_folder = root_folder, img_size = img_size, is_training = False)
